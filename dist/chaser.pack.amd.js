define(['exports', 'three'], function (exports, three_module_js) { 'use strict';
    ...
    const ChaserTween = {
        make : function( position, opts ){
            ...
            return new exports$1.Tween( position )
                .to( o.target, o.time )
    ...
    const defaults = {
        ...
        {
            console.assert( obj instanceof three_module_js.Object3D, "object3D must be instance of THREE.Object3D" );
        ...
        RotationChaser.prototype = Object.assign( Object.create( three_module_js.EventDispatcher.prototype ), {
    ...
    const PositionChaser = function( obj, opt )
    {
        ...
        this.options = Object.assign( {}, defaults$1, opt );
    ...
    PositionChaser.prototype = Object.assign( Object.create( three_module_js.EventDispatcher.prototype ), {
...
//# sourceMappingURL=chaser.pack.amd.js.map
